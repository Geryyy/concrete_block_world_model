...
: Node("block_world_model_node")
{
    ...
    continuous_cfg_.registration_pose_prior_max_result_distance_m =
      startup.continuous_registration_pose_prior_max_result_distance_m;
    ...
    WM_LOG(
      ...
      continuous_cfg_.filtering.temporal_bootstrap_enabled ? "true" : "false",
      continuous_cfg_.filtering.temporal_bootstrap_min_stable_observations,
      continuous_cfg_.filtering.temporal_bootstrap_max_mask_area_change_ratio,
      continuous_cfg_.filtering.temporal_bootstrap_max_mask_centroid_jump_px,
      continuous_cfg_.filtering.temporal_bootstrap_max_position_jump_m,
